...
public class AdapterVerifikasi extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<ModelData> modelDataList;


    public AdapterVerifikasi(Activity activity, List<ModelData> modelDataList){
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) convertView = inflater.inflate(R.layout.adapter_verifikasi, null);
        ...
        sinnerTindakLanjut.setSelection(0);
        ...
        simpanPemantauan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String status="";
                if(sinnerTindakLanjut.getSelectedItem().toString().equals("YA"))
                {
                     status = "Pemantauan";
                }else{
                     status = "Selesai";
