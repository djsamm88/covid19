...
public class PemantauanActivity extends AppCompatActivity {
    private AdapterPemantauan adapterDetailMasuk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v_judul.setText("Data Pemantauan.");
    ...
    private void listData()
    {
        ...
        adapterDetailMasuk = new AdapterPemantauan(this,modelDataList);
        ...
        List<ModelData> transaksis = dbTransaksi.by_status("Pemantauan");
        modelDataList.clear();
