...
public class SelesaiActivity extends AppCompatActivity {
    private AdapterSelesai adapterDetailMasuk;
    ...
    private void listData()
    {
        ...
        adapterDetailMasuk = new AdapterSelesai(this,modelDataList);
        ...
        List<ModelData> transaksis = dbTransaksi.by_status("Selesai");
        modelDataList.clear();
