...
public class AdapterDetailKeluar extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<ModelData> modelDataList;


    public AdapterDetailKeluar(Activity activity, List<ModelData> modelDataList){
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) convertView = inflater.inflate(R.layout.adapter_data_keluar, null);
