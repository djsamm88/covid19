...
public class SakitActivity extends AppCompatActivity {
    private AdapterSakit adapterDetailMasuk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sakit);


        v_judul = (TextView)findViewById(R.id.v_judul);
        v_judul.setText("Data Sakit.");
    ...
    private void listData()
    {
        ...
        adapterDetailMasuk = new AdapterSakit(this,modelDataList);
        ...
        List<ModelData> transaksis = dbTransaksi.by_status("Sakit");
        modelDataList.clear();
        ...
        for(ModelData trx:transaksis)
        {
            ...
            modelData.setKesehatan(trx.getKesehatan());
            modelData.setCatatan_medis(trx.getCatatan_medis());
            modelData.setStatus_akhir(trx.getStatus_akhir());
